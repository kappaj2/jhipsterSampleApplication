package za.co.ajk.test1.web.rest;

import za.co.ajk.test1.JhipsterSampleApplicationApp;
import za.co.ajk.test1.domain.Authority;
import za.co.ajk.test1.domain.User;
import za.co.ajk.test1.repository.UserRepository;
import za.co.ajk.test1.security.AuthoritiesConstants;
import za.co.ajk.test1.service.MailService;
import za.co.ajk.test1.service.UserService;
import za.co.ajk.test1.service.dto.UserDTO;
import za.co.ajk.test1.service.mapper.UserMapper;
import za.co.ajk.test1.web.rest.errors.ExceptionTranslator;
import za.co.ajk.test1.web.rest.vm.ManagedUserVM;
